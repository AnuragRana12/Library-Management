  ...
  document.body.style.backgroundColor = "white";
    ...
    <div class="srch">
        <form class="navbar-form" method="post" name="form1">
                ...
                <button style="background-color: #002147; color:white;" type="submit" name="submit" class="btn btn-default">
    ...
    <div class="srch">
        <form class="navbar-form" method="post" name="form1">
                ...
                <button style="background-color: #002147; color:white" type="submit" name="submit1" class="btn btn-default">Request
                </button>
        </form>
    </div>
