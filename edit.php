...
<body style="background-color: white;">
	...
	<h2 style="text-align: center;color: #002147;">Edit Information</h2>
	<?php
	...
	<div class="profile_info" style="text-align: center;">
		<span style="color: #002147;">Welcome,</span>	
		<h4 style="color: #002147;"><?php echo $_SESSION['login_user']; ?></h4>
	</div><br><br>
	...
	<div class="form1">
		...
		<br>
		<div style="padding-left:100px ;  color: #002147;">
